...
ovpnS.CertSt="Status certyfikatu";
ovpnS.SrvCertExp="Wygaśnięcie certyfikatu serwera";
ovpnS.CrlExp="Wygaśnięcie listy unieważnionych certyfikatów (CRL)";
ovpnS.RenewCrl="Odśwież CRL";
ovpnS.CrlRenewC="Spowoduje to ponowne wygenerowanie listy unieważnionych certyfikatów (CRL). Kontynuować?";
ovpnS.NotConf="Nie skonfigurowano";
...
ovpnS.CfgFOvpn="Pojedynczy plik konfiguracyjny (.ovpn)";
...
ovpnS.UseAUP="Użyj autoryzacji nazwa użytkownika/hasło";
ovpnS.AUPUser="Nazwa użytkownika";
ovpnS.AUPPass="Hasło";
ovpnS.rvel="pokaż";
